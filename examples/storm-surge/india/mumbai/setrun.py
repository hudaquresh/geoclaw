...
if storm_num == 0:  
    # First Batch 0-599 
    landfall = datetime.datetime(1979, 10, 24, 14) - \
                        datetime.datetime(1979, 1,1, 0)
    final_forecast = datetime.datetime(1979, 10, 29, 20) - \
                        datetime.datetime(1979, 10, 24, 14) 
elif storm_num == 600: 
    # Second Batch 600-1199
    landfall = datetime.datetime(1991, 4, 2, 8) - \
                        datetime.datetime(1991, 1,1, 0)
    final_forecast = datetime.datetime(1991, 4, 13, 4) - \
                        datetime.datetime(1991, 4, 2, 6) 
elif storm_num == 1200: 
    # Third Batch 1200-1850 
    landfall = datetime.datetime(2003, 5, 10, 8) - \
...
#------------------------------
    ...
    if clawdata.output_style == 1:
        ...
        clawdata.tfinal = days2seconds(landfall.days + final_forecast.days)
        recurrence = 4
