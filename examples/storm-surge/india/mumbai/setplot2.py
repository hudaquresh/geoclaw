...
for i in xrange(3):
    if storm_num == 1:
        # Storm 1
        gauge_landfall.append(datetime.datetime(1997, 11, 15, 3) - \
datetime.datetime(1997, 1, 1, 0))
    elif storm_num == 2:
        # Storm 2
        gauge_landfall.append(datetime.datetime(2008, 12, 17, 0) - \
...
tick_labels=None):
    ...
    regions = {"Full Domain (Grids)": [[clawdata.lower[0], clawdata.upper[0]],
                               ...
                               [1, 1, 1, 1, 1, 1, 1]],
               "Mumbai Regio (Grids)": [[70, 75], [17, 22], [1, 1, 1, 1, 1, 1,
1]],
               "Mumbai (Grids)": [[72.6, 73.15], [18.80, 19.25], [1, 1, 1, 1, 1,
1, 1]],
               "Full Domain (No Grids)": [[clawdata.lower[0],
clawdata.upper[0]],
                               [clawdata.lower[1], clawdata.upper[1]], 
                               [0, 0, 0, 0, 0, 0, 0]],
               "Mumbai Region (No Grids)": [[70, 75], [17, 22], [0, 0, 0, 0, 0,
0, 0]],
               "Mumbai (No Grids)": [[72.6, 73.15], [18.80, 19.25], [0, 0, 0, 0,
0, 0, 0]]}
