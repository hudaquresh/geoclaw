...
indian_ocean_topo.read(nc_params={"x_var":"lon", "y_var":"lat",
"z_var":"Band1"})
...
# depth_extent = (numpy.min(indian_ocean_topo.Z),
# numpy.max(indian_ocean_topo.Z))
...
indian_ocean_topo.plot(axes=axes, add_colorbar=True, limits=[-300,
topo_extent[1]])
